class TagAssociationsController < ApplicationController
  ...
  def index
    @tag_associations = current_user.tag_associations.all
  end
  ...
  def new
    @tag_association = current_user.tag_associations.biuld
  end
  ...
  def create
    @tag_association = current_user.tag_associations.build(tag_association_params)
  ...
  private
    ...
    def tag_association_params
      params.require(:tag_association).permit(:task_id, :tag_id)
    end
end
